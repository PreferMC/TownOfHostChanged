...
public static class Jackal
{
    ...
    public static OptionItem CanRecruit;
    ...
    public static void SetupCustomOption()
    {
        ...
        CanRecruit = BooleanOptionItem.Create(Id + 14, "CanRecruit", true, TabGroup.NeutralRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Jackal]);
    }
