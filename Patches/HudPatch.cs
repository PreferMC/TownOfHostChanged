...
namespace TownOfHost
{
    ...
    class HudManagerPatch
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            __instance.GameSettings.fontSizeMax = (TranslationController.Instance.currentLanguage.languageID == SupportedLangs.Japanese) ? 1.05f : 1.2f;
            //ゲーム中でなければ以下は実行されない
    ...
    class SetHudActivePatch
    {
        ...
        public static void Postfix(HudManager __instance, [HarmonyArgument(2)] bool isActive)
        {
            ...
            foreach (var role in NewRole.RoleManager.GetRoles())
                if (role.CustomRole == player.GetCustomRole())
                {
                    __instance.SabotageButton.ToggleVisible(role.CanSabotage);
                    __instance.AbilityButton.ToggleVisible(role.CanUseAbility);
                }
